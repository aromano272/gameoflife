...
import com.andreromano.gameoflife.extensions.round
import com.andreromano.gameoflife.extensions.toPx
import java.util.*
...
//        game.sceneSizeChanged(w, h)
    ...
    fun directionChanged(direction: Game2.Direction) {
//        game.directionChanged(direction)
    }

    fun onViewEvent(viewEvent: Game2.ViewEvent) {
